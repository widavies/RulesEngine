...
namespace RulesEngine.HelperFunctions
{
    ...
    public static class Constants
    {
        ...
        public const string INJECT_WORKFLOW_RULES_ERRMSG = "At least one of Rules or WorkflowsToInject must be not empty";
        ...
        public const string VALUE_NOT_SET_EXCLUSIVE_OR_OPERATOR = "Value cannot be set when operator=ExclusiveOr";

        public const string DEFAULT_VALUE_REQUIRES_EXCLUSIVE_OR =
            "DefaultValue can only be set when operator=ExclusiveOr";
        public const string RULE_NAME_NULL_ERRMSG = "Rule name can not be null";
        public const string RULE_NAME_CHARACTERS_ERRMSG = "Rule name must be alphanumeric";
        ...
        public const string REGEX_EXPRESSION_EXPRESSION_NULL_ERRMSG =
            "Expression cannot be null or empty when RuleExpressionType is RegexExpression";
        
        public const string REGEX_EXPRESSION_CASED_EXPRESSION_NULL_ERRMSG =
            "Expression cannot be null or empty when RuleExpressionType is RegexCasedExpression";
